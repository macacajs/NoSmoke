...
program
  ...
  .option('--server <s>',     'adddress for server: `http://127.0.01:3456`')
  .option('--duration <d>',       'timeout interval')
  .option('--deviceName <s>',     'name of device')
  .option('--deviceType <s>',     'type of device')
  .usage('');
