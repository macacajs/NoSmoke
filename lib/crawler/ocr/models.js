...
function NSAppCrawlingTreeNodeAction() {
  ...
  this.location = null;     // source strategy: xpath;  ocr strategy: location in view (NSAppCrawlingTreeNodeActionLocation);
...
NSAppCrawlingTreeNodeAction.prototype.markActionFinish = function (crawler) {
  ...
  if (this.bindedTest &&
    ...
    this.bindedTest.context = `${this.fileName}` || null;
